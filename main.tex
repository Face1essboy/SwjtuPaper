...
\usepackage{pdfpages}			% 用于插入外部PDF页面

% 调整标题留白（覆盖 swjtuThesis.cls 中的默认设置）
% 当前将 subsection 与 subsubsection 的上下间距适当收紧，避免小节标题与正文之间留白过大
% \CTEXsetup[beforeskip = {8pt plus 1pt minus 1pt}, afterskip = {2pt plus 1pt minus 1pt}]{subsection}
% \CTEXsetup[beforeskip = {8pt plus 1pt minus 1pt}, afterskip = {2pt plus 1pt minus 1pt}]{subsubsection}
...
\include{content/mychap01}
\cleardoublepage
\include{content/mychap02}
\cleardoublepage
\include{content/mychap03}
\cleardoublepage
\include{content/mychap04}
\cleardoublepage
\include{content/mychap05}
\cleardoublepage
% 加载论文结论
\include{content/myconclusion}
\cleardoublepage
%---------------------------------------------------------------------------------
...
% \includepdf[pages=-]{figures/研究成果.pdf}	% 盲审版：直接插入研究成果PDF
